...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        fake_cities = ['Metropolis', 'Eerie', "King's Landing", 'Sunnydale', 'Bedrock', 'South Park', 'Atlantis',
                       'Mordor', 'Olympus', 'Dawnstar', 'Balmora', 'Gotham', 'Springfield', 'Quahog', 'Smalltown',
                       'Epicburg', 'Pythonville', 'Faketown', 'Westworld', 'Thundera', 'Vice City', 'Blackwater',
                       'Oldtown', 'Valyria', 'Winterfell', 'Braavos‎', 'Lakeview']
        ...
        for num in range(100):
            ...
            try:
                data=Address.objects.bulk_create([Address(name=first,phone=phone,email=email,address=address,website='www.google.com')])
